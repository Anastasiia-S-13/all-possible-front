...
import { toolSchema } from "@/lib/validation/ragisterValidations";
...
export default function EditToolForm({ tool, onSuccess }: EditToolFormProps) {
  ...
  const handleSubmit = async (values: FormValues) => {
    ...
    try {
      ...
      toast.error(
        err.response?.data?.message || "Помилка при оновленні інструменту"
      );
    } finally {
          ...
          <Form className={styles.form}>
            ...
            <div className={styles.formGroup}>
              ...
              <Field
                ...
                min="0"
                className={`${styles.input} ${
                  errors.pricePerDay && touched.pricePerDay
                    ? styles.inputError
                    : ""
                }`}
              />
            ...
            <div className={styles.formGroup}>
              ...
              <Field
                ...
                className={`${styles.input} ${
                  errors.rentalTerms && touched.rentalTerms
                    ? styles.inputError
                    : ""
                }`}
              />
